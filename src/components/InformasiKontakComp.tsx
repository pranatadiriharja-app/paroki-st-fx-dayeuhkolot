...
import { MapPin, Phone, Mail, Clock, Send, CheckCircle, AlertCircle, Map, ExternalLink, Youtube, Instagram, Share2 } from "lucide-react";
        ...
        <div className="lg:col-span-7 bg-white rounded-[2rem] border border-[#E5E3DB] p-6 md:p-8 shadow-sm space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                {/* EDIT LINK GOOGLE MAPS DI BAWAH INI (Ketika tombol diklik) */}
                <a
                  href="https://maps.app.goo.gl/84dqbMkm9QyNuqkL9"
                  target="_blank"
                  rel="noreferrer"
            ...
            {/* Media Sosial Resmi */}
            <div className="flex items-start gap-4 border-t border-[#E5E3DB]/70 pt-5">
              <div className="p-3 bg-[#F5F4F0] border border-[#E5E3DB] rounded-2xl text-[#D4AF37] flex-shrink-0">
                <Share2 className="h-6 w-6" />
              </div>
              <div className="space-y-3 flex-1">
                <h3 className="font-bold text-[#2D3E50] text-sm md:text-base">Media Sosial Resmi</h3>
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    href="https://www.youtube.com/channel/UCTQyM-Cv3G6tBy_Tv48wXKQ"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 bg-[#FF0000]/10 hover:bg-[#FF0000] text-[#FF0000] hover:text-white border border-[#FF0000]/20 px-4 py-2 rounded-xl font-bold text-xs uppercase tracking-wider transition-all shadow-sm"
                  >
                    <Youtube className="h-4 w-4" /> Channel YouTube
                  </a>
                  <a
                    href="https://www.instagram.com/gereja.dakol/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 bg-[#E1306C]/10 hover:bg-[#E1306C] text-[#E1306C] hover:text-white border border-[#E1306C]/20 px-4 py-2 rounded-xl font-bold text-xs uppercase tracking-wider transition-all shadow-sm"
                  >
                    <Instagram className="h-4 w-4" /> Instagram @gereja.dakol
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-[2rem] overflow-hidden border border-[#E5E3DB] shadow-inner h-64 relative bg-[#F5F4F0]">
            <iframe
              ...
              src="https://maps.google.com/maps?q=Gereja%20Katolik%20Santo%20Fransiskus%20Xaverius%20Dayeuhkolot&t=&z=16&ie=UTF8&iwloc=&output=embed"
